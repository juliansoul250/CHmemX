...
The project is designed to prevent accidental workflow mistakes. It does not authenticate Agent
IDs and is not a security boundary against malicious processes running as the same OS user.
